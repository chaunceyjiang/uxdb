...
# test_uxdb_dbapi20.py - DB API conformance test for uxdb
#
...
class uxdbTests(dbapi20.DatabaseAPI20Test):
    driver = uxdb
    connect_args = ()
    ...
    def test_setoutputsize(self):
        # uxdb's setoutputsize() is a no-op
        pass

    def test_nextset(self):
        # uxdb does not implement nextset()
        pass


@skip_if_tpc_disabled
class uxdbTPCTests(dbapi20_tpc.TwoPhaseCommitTests, unittest.TestCase):
    driver = uxdb

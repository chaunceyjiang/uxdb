...
import uxdb
from uxdb import extensions
from uxdb.extensions import Notify
...
""" % {
    ...
    def test_notify_object(self):
        ...
        self.assert_(isinstance(notify, uxdb.extensions.Notify))
    ...
    def test_notify_init(self):
        n = uxdb.extensions.Notify(10, 'foo')
        ...
        n = uxdb.extensions.Notify(42, 'bar', 'baz')
    ...
    def test_compare(self):
        ...
        for d1 in data:
            for d2 in data:
                n1 = uxdb.extensions.Notify(*d1)
                n2 = uxdb.extensions.Notify(*d2)

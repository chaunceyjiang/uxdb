...
# test_errors.py - unit test for uxdb.errors module
#
...
import uxdb
from uxdb import errors
from uxdb._psycopg import sqlstate_errors
from uxdb.errors import UndefinedTable
...
class ErrorsTests(ConnectingTestCase):
    ...
    def test_has_base_exceptions(self):
        ...
        excs.append(uxdb.extensions.QueryCanceledError)
        excs.append(uxdb.extensions.TransactionRollbackError)

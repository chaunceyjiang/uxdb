...
class AsyncTests(ConnectingTestCase):
    ...
    def test_rollback_while_async(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, self.conn.rollback)
    ...
    def test_commit_while_async(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, self.conn.commit)
        self.assertTrue(self.conn.isexecuting())
    ...
    def test_reset_while_async(self):
        ...
        # a reset should fail
        self.assertRaises(uxdb.ProgrammingError, self.conn.reset)
    ...
    def test_async_iter(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, list, cur)
    ...
    def test_async_scroll(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, cur.scroll, 1)
        self.assertTrue(self.conn.isexecuting())
        ...
        cur2 = self.conn.cursor()
        self.assertRaises(uxdb.ProgrammingError, cur2.scroll, 1)

        self.assertRaises(uxdb.ProgrammingError, cur.scroll, 4)
    ...
    def test_async_fetch_wrong_cursor(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, cur2.fetchone)
    ...
    def test_error(self):
        ...
        cur.execute("insert into table1 values (%s)", (1, ))
        # this should fail
        self.assertRaises(uxdb.IntegrityError, self.wait, cur)
    ...
    def test_stop_on_first_error(self):
        ...
        self.assertRaises(uxdb.errors.UndefinedColumn, self.wait, cur)
    ...
    def test_error_two_cursors(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, self.wait, cur)
    ...
    def test_async_cursor_gone(self):
        ...
        del cur
        gc.collect()
        self.assertRaises(uxdb.InterfaceError, self.wait, self.conn)
    ...
    def test_copy_no_hang(self):
        ...
        self.assertRaises(uxdb.ProgrammingError, self.wait, self.conn)
    ...
    def test_non_block_after_notification(self):
        ...
        while True:
            ...
            if state == uxdb.extensions.POLL_OK:
                break
            elif state == uxdb.extensions.POLL_READ:
                select([self.conn], [], [], 0.1)
            elif state == uxdb.extensions.POLL_WRITE:
                select([], [self.conn], [], 0.1)
            else:

...
uxdb is a PostgreSQL database adapter for the Python programming
language.  uxdb was written with the aim of being very small and fast,
and stable as a rock.

uxdb is different from the other database adapter because it was
designed for heavily multi-threaded applications that create and destroy
lots of cursors and make a conspicuous number of concurrent INSERTs or
UPDATEs. uxdb also provide full asynchronous operations and support
...
pg_config is required to build uxdb from source.  Please add the directory
...
If you prefer to avoid building uxdb from source, please install the PyPI
'uxdb-binary' package instead.
...
You may install a binary package by installing 'uxdb-binary' from PyPI.
If you want to install uxdb from source, please install the packages
...
""")
        ...
        if self.compiler_is_msvc() and sysVer == (2, 7):
            ...
            # called. https://github.com/psycopg/uxdb/issues/380
...
ext.append(Extension("uxdb._psycopg", sources,
...
setup(name="uxdb",
      ...
      package_dir={'uxdb': 'lib'},
      packages=['uxdb'],
      cmdclass={'build_ext': psycopg_build_ext},
      ext_modules=ext,
      project_urls={
          'Source': 'https://github.com/chaunceyjiang/uxdb',
      ...
      entry_points={
          'sqlalchemy.dialects': ['uxdb = uxdb.sqlalchemy_uxdb:PGDialect_uxdb',
                                  ]
      },
      )

"""Miscellaneous goodies for uxdb
...
import uxdb
from uxdb import extensions as _ext
...
from uxdb._psycopg import (                             # noqa
...
from uxdb._ipaddress import register_ipaddress          # noqa
...
class StopReplication(Exception):
    ...
    `~uxdb.Error` as occurrence of this exception does not indicate an
    error.
    """
    pass
...
def execute_values(cur, sql, argslist, template=None, page_size=100, fetch=False):
    ...
    **not** contain a total result.
    ...
    '''
    from uxdb.sql import Composable

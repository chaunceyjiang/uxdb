...
"`uxdb.extensions`: see :ref:`transaction-status-constants` for the\n"
"available values.\n"
"\n"
":type: `!int`\n"
"\n"
...
"`~uxdb.NotSupportedError` otherwise.\n"
"\n"
":type: `!bool`\n"
"\n"
...
conninfo_init(connInfoObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (!PyObject_TypeCheck(conn, &connectionType)) {
        PyErr_SetString(PyExc_TypeError,
            "The argument must be a uxdb connection");
        return -1;
    }
...
PyTypeObject connInfoType = {
    ...
    "uxdb.extensions.ConnectionInfo",
